package com.taipei.iot.tenant.validation;
...
public class TenantConsistencyValidator {
	 ...
	 */
	public static Set<Class<?>> resolveTenantAwareEntities(EntityManagerFactory emf) {
	 ...
	 */
	public static List<String> checkConsistency(Set<Class<?>> tenantAwareEntities,
