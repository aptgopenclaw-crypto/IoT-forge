 ...
 * 之內執行：方法執行期間 {@code TenantContext} 為 SYSTEM，結束後自動恢復先前 context。
 *
 * <p>
 * 由 {@code TenantSystemContextAspect} 透過 Spring AOP 實作。
 *
 * <p>
 ...
 * {@code TenantContext.runInSystemContext(Runnable)} /
 * {@code TenantContext.runInSystemContext(Supplier)}。</li>
 * </ul>
 *
 * <p>
