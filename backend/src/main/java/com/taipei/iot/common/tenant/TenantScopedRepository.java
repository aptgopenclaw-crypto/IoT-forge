 ...
 * <p>
 * {@code TenantFilterAspect} 只對實作此介面的 Repository 強制要求
 * {@link com.taipei.iot.common.context.TenantContext}：
 * <ul>
 * <li>若 {@code TenantContext.isSystemContext()} 為 true → 跳過 filter（允許跨租戶操作）</li>
 * <li>若 {@code TenantContext.getCurrentTenantId()} 非 null → 啟用 tenantFilter</li>
